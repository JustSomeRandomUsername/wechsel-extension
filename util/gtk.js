...
export const IconSelector = GObject.registerClass(class IconSelector extends Gtk.Overlay {
    ...
    constructor(
        ...
        filePickerBtn.add_css_class('inset');
        filePickerBtn.set_tooltip_text(_('Select an icon for the project'));
...
export const HBoxGroup = GObject.registerClass(class HBoxGroup extends Adw.PreferencesGroup{
    constructor(...args) {
        super(...args);
        /** @type {Gtk.ListBoxRow} The single row containing the HBox */
        ...
        row.set_child(this.hbox);
    }

    append(...args) {
        this.hbox.append(...args);
    }
