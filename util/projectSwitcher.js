...
const ProjectSwitcher = GObject.registerClass(
    class InputSourceSwitcher extends SwitcherPopup.SwitcherList {
        constructor(items, has_parent, iconPaths) {
            super(true);
        ...
        _addIcon(item, root) {
            ...
            const iconPath = this.iconPaths.get(item.name);
...
const ProjectSwitcherPopup = GObject.registerClass(
    class InputSourcePopup extends SwitcherPopup.SwitcherPopup {
        constructor(action, actionBackward, indicator, binding, root_prj, iconPaths, active = "", selections = []) {
            ...
            this._switcherList = new ProjectSwitcher(this._items, this._selections.length !== 1, iconPaths);
        }
